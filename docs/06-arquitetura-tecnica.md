...
| Auth            | Better Auth                                                                 | Email OTP + Google OAuth sem senha (magic link descartado: quebra em in-app browser mobile), dono da tabela de users no nosso Postgres                                                                                                 | Auth.js, Clerk (custo/lock-in)                                                                         |
